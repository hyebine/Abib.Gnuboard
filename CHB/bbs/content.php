...
if(is_file($skin_file)) {
    ...
    if (file_exists($himg)) // 상단 이미지
        echo run_replace('content_head_image_html', '<div id="ctt_himg" class="ctt_img d-flex align-items-center justify-content-center '.$co_id.'" style="background:url('.$himgbg.') no-repeat center; "><h2 id="container_title" class="mb-0"><span title="'.get_text($g5['title']).'">'.get_head_title($g5['title']).'</span></h2></div>', $co);
